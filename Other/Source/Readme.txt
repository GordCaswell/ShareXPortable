...
user in an INI file next to ShareXPortable.exe called ShareXPortable.ini.
...
copy AppNamePortable.ini from this directory to ShareXPortable.ini next to
ShareXPortable.exe. The options in the INI file are as follows:
